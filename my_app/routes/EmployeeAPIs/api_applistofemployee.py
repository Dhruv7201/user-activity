...
async def applistofemployee(request: Request,
    ...
    if from_date and to_date:
        ...
        user_data = collection.find({'date': {'$gte': from_date, '$lte': to_date}, 'user_id': {'$in': user_list}})
    else:
        # Filter user data based on users present in user_list
    ...
    for doc in user_data:
        ...
        for item in doc['list_of_app']:
            ...
            matched = False
            group = {'group_name': 'Other', 'window_title': window_title, 'app_time': item['used_time']}
