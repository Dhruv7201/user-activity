    ...
    for date in all_dates:
        if date not in user_data_collection.distinct("date"):
            ...
            for user in user_list:
                ...
                if user_data:
                    total_idle_time += timedelta(
                        hours=int(user_data["idle_time"].split(":")[0]),
                        minutes=int(user_data["idle_time"].split(":")[1]),
                        seconds=int(user_data["idle_time"].split(":")[2]),
                    )
